---
title: Announcing Chez Grater Version 0.1
---

Announcing [Chez Grater](https://hackage.haskell.org/package/chez-grater), a new open source tool
for scraping recipe blogs. Powers [Nomz](https://app.mo-nomz.com). Check it out! Feedback and enhancements
welcome at [https://github.com/dfithian/chez-grater](https://github.com/dfithian/chez-grater).
